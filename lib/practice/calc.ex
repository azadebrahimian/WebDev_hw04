defmodule Practice.Calc do
    # Credit for postfix algorithm: https://www.geeksforgeeks.org/stack-set-2-infix-to-postfix/
    ...
    # Credit for calculating postfix expression algorithm: https://medium.com/@eauditory3/what-are-stack-based-calculators-cf2dbe249264
